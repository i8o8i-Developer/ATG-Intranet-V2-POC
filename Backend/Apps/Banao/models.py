...
class LeadAccount(TenantScopedModel, ExternalReference):
    ...
    call_status = models.CharField(max_length=30, blank=True, db_index=True)
    call_updated_at = models.DateTimeField(null=True, blank=True)
    takeover_from = models.ForeignKey("Users.EmployeeProfile", null=True, blank=True, on_delete=models.SET_NULL, related_name="leads_taken_over")
